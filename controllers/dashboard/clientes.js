...
const USUARIO_API = 'business/dashboard/cliente.php';
        ...
        JSON.dataset.forEach(row => {
            ...
            TBODY_ROWS.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#save-modal"onclick="openUpdate(${row.id_cliente})">
