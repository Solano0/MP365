...
const USUARIO_API = 'business/dashboard/valoraciones.php';
        ...
        JSON.dataset.forEach(row => {
            ...
            TBODY_ROWS.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#save-modal"onclick="openUpdate(${row.id_valoracion})">
                            <i class="fa-solid fa-circle-plus"></i></button>
                            
                        <a onclick="openDelete(${row.id_valoracion})" class="btn waves-effect red tooltipped" data-tooltip="Eliminar">
