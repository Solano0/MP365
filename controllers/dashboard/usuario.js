        ...
        JSON.dataset.forEach(row => {
            ...
            TBODY_ROWS.innerHTML += `
                <tr>
                    ...
                    <td>${row.usuario}</td>
                    <td>
                        <button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#save-modal"onclick="openUpdate(${row.id_usuario})">
...
async function openUpdate(id) {
    ...
    if (JSON.status) {
        ...
        document.getElementById('alias').value = JSON.dataset.usuario;
