        ...
        JSON.dataset.forEach(row => {
            ...
            TBODY_ROWS.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#save-modal"onclick="openUpdate(${row.id_categoria})">
                        <i class="fa-solid fa-circle-plus"></i></button>
                        <a onclick="openDelete(${row.id_categoria})" class="btn waves-effect red tooltipped" data-tooltip="Eliminar">
