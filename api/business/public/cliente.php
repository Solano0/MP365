...
if (isset($_GET['action'])) {
    ...
    if (isset($_SESSION['id_cliente'])) {
        ...
        /**
         * Login obtenderemos y compararemos los datos en la base y en el formulario
         * Singup registraremos un nuevo usuario el cual tiene que ser mayor a 18 años y tiene que tener dui.
         * Recaptcha metodo para comprobar si si eres humano, esto quiere decir que un bot no este rellenando el formulario.
         */
        switch ($_GET['action']) {
            case 'getUser':
                if (isset($_SESSION['nombre_cliente'])) {
                    $result['status'] = 1;
                    $result['username'] = $_SESSION['nombre_cliente'];
                } else {
