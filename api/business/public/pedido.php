...
if (isset($_GET['action'])) {
    ...
    if (isset($_SESSION['id_cliente'])) {
        ...
        /**
         * Create detail es para  crear el pedido del usuario que se agregara al carrito.
         * Read roder detail es para comprobar y leer los productos agregados al carrito.
         * update cambiamos el numero de productos los cuales pediremos.
         * Delete eliminamos el producto del carrito.
         * finish order Finalizaremos la orden agregando los datos de fecha y zona que se hizo la compra.
         */
        switch ($_GET['action']) {
            case 'createDetail':
